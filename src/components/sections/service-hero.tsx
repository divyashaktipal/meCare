  ...
  return (
    <section className="bg-[#F4FAF8] pt-16 md:pt-24 pb-16">
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <div className="relative aspect-video md:aspect-[21/9] rounded-4xl overflow-hidden shadow-xl max-w-5xl mx-auto border-4 border-white/50">
          <div className="absolute inset-0 bg-[#F4FAF8]/20"></div>
          <img src="./servicesImg1.png" alt="Doctor Hands" className="w-full h-full object-cover object-center relative z-10" />
        </div>
      </div>
    </section>
  );
