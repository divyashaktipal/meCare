    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
          <div className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-sm text-primary" style={{ fontWeight: 400 }}>
            Our Services
          </div>
          <h2 className="text-3xl tracking-tight sm:text-4xl" style={{ fontWeight: 600 }}>Specialized Care For You</h2>
          ...
          {services.map((service, index) => (
            <Card key={index} className="group hover:border-primary/50 hover:shadow-md transition-all duration-300">
              ...
              <CardContent>
                ...
                <Button variant="ghost" className="p-0 h-auto text-primary hover:text-primary-hover hover:bg-transparent" style={{ fontWeight: 400 }}>
                  Learn more →
                </Button>
              </CardContent>
            </Card>
