    ...
    <section className="py-24 bg-muted">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">Choose your pricing plan</h2>
          ...
          <div className="flex items-center justify-center gap-4 mt-10">
            {/* Monthly option */}
            <span
              className={`text-sm font-bold transition-colors cursor-pointer ${!isYearly ? "text-white" : "text-white/40"
                }`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 max-w-4xl mx-auto items-stretch">
          ...
          <div className="rounded-l-3xl p-8 md:p-12 bg-[#eafffb] border-0 flex flex-col shadow-sm">
            ...
            <Button
              className="w-full rounded-xl bg-white hover:bg-white/90 border-none h-12 md:h-14 font-bold shadow-sm"
              style={{ color: '#03112E' }}
            >
              Choose Your Plan
            </Button>
          ...
          <div className="rounded-r-3xl p-8 md:p-12 bg-[#1A3B47] text-white flex flex-col shadow-xl">
            ...
            <Button className="w-full rounded-xl bg-[#5ACDCA] hover:bg-[#4bc9c1] border-none text-white h-12 md:h-14 font-bold shadow-lg">Choose Your Plan</Button>
          </div>
        </div>
      </div>
    </section>
