        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 auto-rows-[250px]">
          <div className="lg:col-span-2 rounded-3xl bg-[#4bc9c1]/20 p-8 flex flex-col justify-between overflow-hidden relative">
            <div className="z-10 w-2/3">
              <h3 className="text-2xl md:text-3xl font-bold mb-3 text-foreground">Empowering Health professionals</h3>
              <p className="text-md md:text-sm text-foreground/80 mt-4 line-clamp-3">Provide specialized and personalized care mapping patient data with advanced predictive models for proactive medical advice.</p>
              <Button className="rounded w-fit  text-[#0D1525] font-semibold mt-12 bg-white hover:bg-gray-100" size="sm">Learn More</Button>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-[#0070bc] text-white p-8 flex flex-col justify-between relative overflow-hidden">
            ...
            <Button className="rounded w-fit  text-[#0D1525] font-semibold z-10 bg-white hover:bg-gray-100" size="sm">Try Now
